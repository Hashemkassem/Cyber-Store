    ...
    return Container(
      ...
      child: CarouselSlider.builder(
        ...
        itemBuilder: (context, index, realIndex) {
          return RobotItems(
              bigimage: robotlist[index].bigImage,
              information: robotlist[index].information,
              id: robotlist[index].id,
              image: robotlist[index].image,
              subinfo: robotlist[index].subinfo,
              name: robotlist[index].name);
        },
      ),
    );
  }
